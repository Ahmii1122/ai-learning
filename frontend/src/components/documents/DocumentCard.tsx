...
const DocumentCard = ({ document, onDelete }: Props) => {
  ...
  return (
    <div
      className="group relative bg-white border border-slate-200/60 rounded-2xl p-5 hover:border-slate-300/60 hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-300 flex flex-col justify-between cursor-pointer hover:-translate-y-1"
    ...
    >
      ...
      <div className="absolute inset-0 rounded-2xl bg-linear-to-br from-emerald-500/10 to-teal-500/5 opacity-0 group-hover:opacity-100 transition-all duration-500 pointer-events-none" />
    </div>
  );
};
